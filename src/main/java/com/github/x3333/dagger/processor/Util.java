...
final class Util {
  ...
  static Iterable<AnnotationSpec> annotationMirrorToSpec(final Iterable<? extends AnnotationMirror> mirrors) {
    return Iterables.transform(mirrors, AnnotationSpec::get);
  }

  static MethodSpec.Builder copyConstructor(final ExecutableElement el) {
  ...
  static MethodSpec.Builder copyMethod(final ExecutableElement el, final Class<? extends Annotation> targetAnnotation) {
  ...
  static ParameterSpec.Builder copyParameter(final VariableElement element) {
